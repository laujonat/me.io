...
function Box({ children, ...props}) {
  useEffect(() => {
    setTimeout(() => {
      ...
      var tween3 = kute.fromTo(el3, { rotateY: 0 }, { rotateY: 160 }, { perspective: 100 });
      var tween4 = kute.fromTo(el4, { translate3d: [0, 0, 0] }, { translate3d: [0, 0, -100] }, { parentPerspective: 100 });
      tween1.start();
      tween2.start();
      tween3.start();
      tween4.start();
